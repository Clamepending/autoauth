...
export default function AdminDashPage() {
  ...
  return (
    <main style={{ padding: 48, maxWidth: 1200, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
      ...
      >
        <section style={{ border: "1px solid var(--line)", background: "var(--paper)", padding: 20 }}>
          ...
          {closedRequests.length > 0 && (
            <div>
              <h3 style={{ fontSize: 16, margin: "0 0 10px 0" }}>Resolved / Past Requests</h3>
              <div style={{ border: "1px solid var(--line)", background: "var(--paper)", overflowX: "auto" }}>
                <table style={{ minWidth: 560, width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                <thead>
        ...
        <section style={{ border: "1px solid var(--line)", background: "var(--paper)", padding: 20 }}>
          ...
          {agents.length === 0 ? (
            ...
            <div style={{ border: "1px solid var(--line)", background: "var(--paper)", overflowX: "auto" }}>
              <table style={{ minWidth: 520, width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid var(--line)", background: "var(--bg)" }}>
                ...
                <tbody>
                  {agents.map((a) => (
                    <tr key={a.id} style={{ borderBottom: "1px solid var(--grid)" }}>
                      ...
                      <td style={{ padding: "12px 16px", color: "var(--muted)", maxWidth: 260, wordBreak: "break-all" }}>
                        {a.callback_url ?? "-"}
                      </td>
