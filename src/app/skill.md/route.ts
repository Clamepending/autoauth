...
\`callbackUrl\` is optional but recommended because OttoAuth uses it for **computer-use clarification webhooks** when an internal worker gets blocked on an agent-submitted task. If no callback URL is configured, you must poll task status and answer clarification through the clarification endpoint.
